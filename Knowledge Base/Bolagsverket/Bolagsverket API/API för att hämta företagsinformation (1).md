...
source: "https://bolagsverket.se/apierochoppnadata/hamtaforetagsinformation/apiforatthamtaforetagsinformation.3988.html#h-VilkeninformationkanjagfaviaAPIet"
author:
...
| Informationsmängd | Beskrivning |
| --- | --- |
| Ärende | Information about the case at Bolagsverket, which registered the data in the register of beneficial owners. |
| Organisation | Information about the organisation. Including information about registered suspicion that the data may be incorrect. |
| Verkliga huvudmän | Information about persons registered as beneficial owners for the organisation. |
| Företrädare | Information about persons registered as representatives of the organisation. |
...
| Informationsmängd | Beskrivning |
| --- | --- |
| idNaringsidkarkombination | ID of the economic operators holding the business mortgage (used when more than one is holding the business mortgage). |
| Näringsidkare | Information about the economic operator(s) holding the business mortgage. |
| Anmärkning näringsidkare | Container for information about remarks on the registration. |
| Upplägg | Business mortgage registrations. An registration may contain several business mortgages. Holds information about amount etc. |

Mer detaljer om innehållet och teknisk information hittar du inne i vår [API-portal Länk till annan webbplats.](https://portal.api.bolagsverket.se/devportal/apis/3e90ead0-d992-49cc-a02d-7984c27c2164/overview).
